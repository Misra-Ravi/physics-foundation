...
var BASE_URL     = 'https://physicsfoundation.netlify.app/';
...
function doGetStudent(e) {
  ...
  var html = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>IB Physics Portal</title>'+css+'</head><body>'+
    '<header><div class="hi"><div class="lbl">Physics Foundations by Ravi</div><h1>'+student.StudentName+'</h1><div class="nav-links" style="margin-top:14px;display:flex;gap:14px;flex-wrap:wrap;">'+'<a href="https://physicsfoundation.netlify.app/schedule.html" target="_blank" style="color:rgba(255,255,255,.75);font-size:.8rem;font-weight:700;text-decoration:none;">📅 Schedule</a>'+'<a href="https://physicsfoundation.netlify.app/rules.html" target="_blank" style="color:rgba(255,255,255,.75);font-size:.8rem;font-weight:700;text-decoration:none;">📋 Rules</a>'+'<a href="https://physicsfoundation.netlify.app/vision.html" target="_blank" style="color:rgba(255,255,255,.75);font-size:.8rem;font-weight:700;text-decoration:none;">🎯 Vision</a>'+'</div></div></header>'+
